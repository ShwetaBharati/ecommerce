...
@section('page_title','Manage bottom Banner')
@section('container')
<!-- @if($id>0) 
       {{$image_required=""}}
       @else
   ...
   @endif -->
<div class="row">
    <h1> Manage bottom Banner</h1>
    {{session('sku_error')}}

    <br>
    <div class="col-lg-12">

        <form action="{{route('banner.manage_bottom_banner_process')}}" method="post" enctype="multipart/form-data">
            <div class="card-body">
                <div class="card-title">
                    <h3 class="text-center title-2">Manage bottom Banner</h3>
                </div>
                <hr>
                @csrf
